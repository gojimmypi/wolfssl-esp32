...
// we're making some changes / edits to the test.h locally for now
// #include <wolfssh/test.h>
#include "test.h"

#include <wolfssl/wolfcrypt/ecc.h>

// this too is being ported to the ESP32, so is being modified locally instead of example directory. (not in this repo)
#include "server.h"
...
static int main_alt(int argc, char** argv)
{
	func_args args;
